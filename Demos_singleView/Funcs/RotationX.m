function pnt_new = RotationX(pnt_origin, alpha) 
% Function: general coordinates rotation  around X-axis.
% Input:
...
% pnt_new = RotationX(pnt_origin, alpha);
...
%
Rot = [1 0 0; 0 cosd(alpha) -sind(alpha); 0 sind(alpha) cosd(alpha)];
